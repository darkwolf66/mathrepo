...
@section('content')
    <section class="banner-2 section-padding" style="padding-top: 15px; padding-bottom: 15px">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-xl-6 col-lg-6">
                    <div class="banner-content">
                        <span class="subheading">online</span>
                        <h1>Um repositório de projetos de matematica!</h1>
                        <p>
    ...
    <!-- Banner Section End -->
    <section class="section-padding popular-course-list" style="padding-top: 50px; padding-bottom: 30px">
            <div class="container">
    ...
    <!-- Banner Section End -->
    <section class="section-padding popular-course-list" style="padding-top: 0">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-8 col-md-8">
                    <div class="section-heading mb-sm-0">
                        <h3>Colaboradores em projetos</h3>
                        <p>
                            Aqui está a lista das pessoas que colaboraram em projetos
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4  col-md-4">
